    ...
    <div className='w-10/12 mx-auto'>
        ...
        <div className='mt-20 md:w-9/12 mx-auto '>
            ...
            <div className='my-10 sm:w-10/12 mx-auto'>
                <h1 className='text-2xl font-bold mb-4 text-orange-200'>Landing Page</h1>
                <div className='text-orange-100'>A landing page for designers made with basic html, css with great color combination.</div>
        ...
        <div className='mt-20 md:w-9/12 mx-auto '>
            ...
            <div className='my-10 sm:w-10/12 mx-auto'>
                <h1 className='text-2xl font-bold mb-4 text-purple-600'>React:News Website</h1>
                <div className='text-purple-400'>A news website using the React framework, which continuously provides the latest updates and discussions from around the world. <h1 className='mt-4'> This dynamic platform utilizes real-time data fetching from the Yahoo News API, ensuring that users are constantly informed with up-to-date news content.</h1></div>
                <div className='mt-6 inline-block'><a href="" className='flex items-center px-4 py-1 border-[0.5px] border-slate-500 rounded-3xl bg-neutral-800 hover:bg-neutral-700'>Explore <BsArrowUpRight size={14} className='ml-2'/></a></div>
            </div>
        </div>
        <div className='mt-20 md:w-9/12 mx-auto '>
