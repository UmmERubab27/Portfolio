...
const Tools = (props: Props) => {
  return (
    <div className='w-10/12 mx-auto'>
        <h1 className='md:text-4xl text-3xl lg:text-5xl font-bold text-green-400'>Tools</h1>
        <p className='pt-6 text-green-200'>The products, apps and services I use on a daily basis for work and life.</p>
        <div className='mt-20 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-10'>
            ...
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                ...
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold text-red-400'>Figma</h1>
                    <p className='text-red-400 '>My design tool of choice</p>
                </div>
            </a>
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='py-8 bg-neutral-800 w-full text-center rounded-t-2xl'>
                ...
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold text-blue-400'>Vs Code</h1>
                    <p className='text-blue-400'>Use for Most of my developed Apps</p>
                </div>
            </a>
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                <div className='py-8 bg-neutral-800 w-full text-center rounded-t-2xl'>
            ...
            <a href="" className='border-[0.5px] border-neutral-500 block rounded-2xl my-6'>
                ...
                <div className='p-8 py-10'>
                    <h1 className='mb-1 font-bold text-pink-600'>Dribbble</h1>
                    <p className='text-pink-600'>Daily Inspiration for my projects</p>
                </div>
            </a>
        </div>
    </div>
