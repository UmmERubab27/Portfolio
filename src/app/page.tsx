  ...
  return (
    <div className='max-w-[1280px]'>
      ...
      <div className='w-10/12 mx-auto my-10'>
        <div className='flex items-start text-2xl text-neutral-300'><p className='text-5xl mr-2 mt-[2px] text-pink-600'>&#169;</p> Copy Rights <small className='mt-[2px] ml-2 text-purple-600'>18 November 2023</small> </div>
      </div>
    </div>
  )
}
